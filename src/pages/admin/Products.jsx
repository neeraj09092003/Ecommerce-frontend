...
const Products = () => {
  ...
  const fetchAdminProducts = async () => {
    setLoading(true);
    try {
      const res = await axios.get("https://ecommercebackend-grx8.onrender.com/api/products", {
        headers: {
  ...
  const handleAddProduct = async () => {
    ...
    setAdding(true);
    try {
      await axios.post("https://ecommercebackend-grx8.onrender.com/api/products", newProduct, {
  ...
  const submitEdit = async () => {
    ...
    try {
      await axios.put(
        `https://ecommercebackend-grx8.onrender.com/api/products/${editingProduct._id}`,
        editForm,
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`https://ecommercebackend-grx8.onrender.com/api/products/${id}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
